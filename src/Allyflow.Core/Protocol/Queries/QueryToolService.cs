...
public sealed class QueryToolService
{
    ...
    private Allyflow.Core.Snapshots.SnapshotResult? _activeWindowSnapshot;
    private Allyflow.Core.Snapshots.SnapshotResult? _focusContextSnapshot;
    private readonly LinkedList<Allyflow.Core.Snapshots.SnapshotResult> _recentWindowSnapshots = [];
    ...
    public ToolResult<Allyflow.Core.Snapshots.SnapshotResult> WindowsSnapshot(WindowsSnapshotRequest request)
    {
        try
        {
            ...
            var normalizedSnapshot = new Allyflow.Core.Snapshots.SnapshotResult(
                snapshot.WindowRef,
            ...
            return new ToolResult<Allyflow.Core.Snapshots.SnapshotResult>(normalizedSnapshot, null);
        }
        catch (InvalidOperationException ex)
        {
            return new ToolResult<Allyflow.Core.Snapshots.SnapshotResult>(null, new ToolError(
    ...
    private static Allyflow.Core.Refs.ElementRef? FindFocusedRef(ElementNode root)
    {
    ...
    private ToolResult<Allyflow.Core.Snapshots.SnapshotResult> ResolveScopedSnapshot(SelectorScope scope)
    {
    ...
    private static Allyflow.Core.Refs.WindowRef? TryExtractWindowRef(string reference)
    {
        ...
        return new Allyflow.Core.Refs.WindowRef(windowPart);
    }

    private Allyflow.Core.Snapshots.SnapshotResult GetActiveSnapshot()
    {
    ...
    private Allyflow.Core.Snapshots.SnapshotResult GetSnapshot(Allyflow.Core.Refs.WindowRef windowRef, bool preferActiveCache)
    {
    ...
    private Allyflow.Core.Snapshots.SnapshotResult RefreshFocusSnapshot(Allyflow.Core.Refs.WindowRef windowRef)
    {
        var snapshot = _snapshotBuilder.BuildWindowSnapshot(windowRef);
    ...
    private void RememberSnapshot(Allyflow.Core.Snapshots.SnapshotResult snapshot)
    {
    ...
    private Allyflow.Core.Snapshots.SnapshotResult? ResolveDescribeSnapshot(Allyflow.Core.Refs.WindowRef windowRef, string reference)
    {
    ...
    private static bool SnapshotContainsRef(
        Allyflow.Core.Snapshots.SnapshotResult? snapshot,
        Allyflow.Core.Refs.WindowRef windowRef,
        string reference)
    {
    ...
    private string GetSnapshotCacheName(Allyflow.Core.Snapshots.SnapshotResult snapshot)
    {
    ...
    private static bool IsCachedActiveSnapshot(Allyflow.Core.Refs.WindowRef windowRef, Allyflow.Core.Snapshots.SnapshotResult? snapshot)
    {
    ...
    private static string BuildFocusSummary(
        ...
        IReadOnlyList<Allyflow.Core.Refs.ElementRef> parentChain,
        IReadOnlyList<Allyflow.Core.Refs.ElementRef> siblingRefs,
        IReadOnlyList<Allyflow.Core.Refs.ElementRef> childRefs)
    {
